...
return {
	...
	fisherman = {
		...
		trades = {
			...
			{ E(8,22), { "mcl_fishing:fishing_rod_enchanted", 1, 1 },3, 10 },
			},
	...
	armorer = {
		...
		trades = {
			...
			{ E(5), { "mcl_armor:helmet_iron", 1, 1 }, 12, 1 },
			{ E(9), { "mcl_armor:chestplate_iron", 1, 1 }, 12, 1 },
			{ E(7), { "mcl_armor:leggings_iron", 1, 1 }, 12, 1 },
			{ E(4), { "mcl_armor:boots_iron", 1, 1 }, 12, 1 },
			},

			{
			{ { "mcl_core:iron_ingot", 4, 4 }, E(), 12, 10 },
			{ { "mcl_core:emerald", 36, 36 }, { "mcl_bells:bell", 1, 1 }, 12, 5 },
			{ E(3), { "mcl_armor:leggings_chain", 1, 1 }, 12, 5 },
			{ E(), { "mcl_armor:boots_chain", 1, 1 }, 12, 5 },
			},

			{
			{ { "mcl_buckets:bucket_lava", 1, 1 }, E(), 12, 20 },
			{ { "mcl_core:diamond", 1, 1 }, E(), 12, 20 },
			{ E(), { "mcl_armor:helmet_chain", 1, 1 }, 12, 10 },
			{ E(4), { "mcl_armor:chestplate_chain", 1, 1 }, 12, 10 },
			{ E(5), { "mcl_shields:shield", 1, 1 }, 12, 10 },
			},

			{
			{ E(19, 33), { "mcl_armor:leggings_diamond_enchanted", 1, 1 } , 3, 15},
			{ E(13, 27), { "mcl_armor:boots_diamond_enchanted", 1, 1 }, 3, 15 },
			},

			{
			{ E(13, 27), { "mcl_armor:helmet_diamond_enchanted", 1, 1 }, 3, 30 },
			{ E(21, 35), { "mcl_armor:chestplate_diamond_enchanted", 1, 1 }, 3, 30 },
			},
		},
	},
	leatherworker = {
	...
	weapon_smith = {
		...
		trades = {
			{
			{ { "mcl_core:coal_lump", 15, 15 }, E(), 16, 2 },
			{ E(3), { "mcl_tools:axe_iron", 1, 1 }, 12, 1 },
			{ E(7, 21), { "mcl_tools:sword_iron_enchanted", 1, 1 }, 3, 1 },
			},

			{
			{ { "mcl_core:iron_ingot", 4, 4 }, E(), 12, 10 },
			{ E(36), { "mcl_bells:bell", 1, 1 }, 12, 5 },
			},
			...
			{ E(17, 31), { "mcl_tools:axe_diamond_enchanted", 1, 1 }, 3, 15 },
			},

			{
			{ E(13, 27), { "mcl_tools:sword_diamond_enchanted", 1, 1 }, 3, 30 },
			},
		},
	},
	tool_smith = {
		...
		trades = {
			{
			{ { "mcl_core:coal_lump", 15, 15 }, E(), 16, 2 },
			{ E(), { "mcl_tools:axe_stone", 1, 1 }, 12, 1 },
			{ E(), { "mcl_tools:shovel_stone", 1, 1 }, 12, 1 },
			{ E(), { "mcl_tools:pick_stone", 1, 1 }, 12, 1 },
			{ E(), { "mcl_farming:hoe_stone", 1, 1 }, 12, 1 },
			},
			...
			{ E(6, 20), { "mcl_tools:axe_iron_enchanted", 1, 1 }, 3, 10 },
			{ E(7, 21), { "mcl_tools:shovel_iron_enchanted", 1, 1 }, 3, 10 },
			{ E(8, 22), { "mcl_tools:pick_iron_enchanted", 1, 1 }, 3, 10 },
			{ E(4), { "mcl_farming:hoe_diamond", 1, 1 }, 3, 10 },
			},

			{
			{ { "mcl_core:diamond", 1, 1 }, E(), 12, 30 },
			{ E(17, 31), { "mcl_tools:axe_diamond_enchanted", 1, 1 }, 3, 15 },
			{ E(10, 24), { "mcl_tools:shovel_diamond_enchanted", 1, 1 }, 3, 15 },
			},

			{
			{ E(18, 32), { "mcl_tools:pick_diamond_enchanted", 1, 1 }, 3, 30 },
			},
		},
	},
	cleric = {
	...
	mason =	{
		...
		trades =  {
			...
			--FIXME: { E(), { "Dripstone Block", 4, 4 }, 16, 10 },
			},
